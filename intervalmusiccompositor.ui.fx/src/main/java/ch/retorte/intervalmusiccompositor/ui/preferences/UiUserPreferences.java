...
public class UiUserPreferences extends UserPreferences {
    ...
    private final SimpleObjectProperty<Locale> localeProperty = new SimpleObjectProperty<>();
    private final SimpleBooleanProperty saveFieldStateProperty = new SimpleBooleanProperty();
    private final SimpleBooleanProperty searchUpdateAtStartupProperty = new SimpleBooleanProperty();
    ...
    private SoundEffectOccurrence deserializeSoundEffectOccurrence(String soundEffectOccurrenceString, SoundEffectsProvider soundEffectsProvider) {
        if (soundEffectOccurrenceString.contains(":")) {
            ...
            return new SoundEffectOccurrence(soundEffectFor(parts[0], soundEffectsProvider), Long.parseLong(parts[1]));
        }
        return null;
    }
