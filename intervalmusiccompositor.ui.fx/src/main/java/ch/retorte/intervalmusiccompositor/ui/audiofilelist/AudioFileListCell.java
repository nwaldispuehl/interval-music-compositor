...
class AudioFileListCell extends ListCell<IAudioFile> {
    ...
    private final ResourceBundle resourceBundle = new UiBundleProvider().getBundle().getBundle();

    private final AudioFileListCellController listCellController;
    ...
    private class AudioFileListCellController extends HBox {
        ...
        private final SimpleBooleanProperty isBpmSupported = new SimpleBooleanProperty(false);
        private final SimpleBooleanProperty isReady = new SimpleBooleanProperty(false);

        private final Image processing = new Image(getClass().getResource("/images/tracklist/processing_icon.gif").toString());
        private final Image ok = new Image(getClass().getResource("/images/tracklist/music_icon.png").toString());
        private final Image error = new Image(getClass().getResource("/images/tracklist/error_icon.png").toString());
        private final Image warning = new Image(getClass().getResource("/images/tracklist/tooshort_icon.png").toString());
        private final Image queued = new Image(getClass().getResource("/images/tracklist/queued_icon.png").toString());
