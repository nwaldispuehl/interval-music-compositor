...
//		ArrayList<Agent> goodAgents = agents.goodAgents();
//
//		System.out.println("=== Agents ");
//		for(Agent a: goodAgents) {
//			System.out.println("Agent " + a.idNumber + ": " + a.phaseScore + a.tempoScore);
//		}
//		System.out.println("===");
//		
//		ArrayList<EventList> result = new ArrayList<EventList>();
//		
//		for(Agent a: goodAgents) {
//			a.fillBeats(beatTime);
//			result.add(a.events);
//		}
